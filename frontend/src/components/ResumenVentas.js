  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
      ...
      {loading ? <LoadingState /> : !summary ? (
        ...
        <Box sx={{ width: '100%' }}>
          {/* KPIs: siempre 2 por fila usando Box flex, no Grid anidado */}
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', mb: 1.5 }}>
            {[
              ...
              // calc(50% - 6px) = mitad del ancho menos la mitad del gap
          ...
          {summary.total_general > 0 && (
            <Paper sx={{ p: 2, mb: 2, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', width: '100%', boxSizing: 'border-box' }}>
          ...
          {/* Donut */}
          <Paper sx={{ p: 2.5, borderRadius: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', width: '100%', boxSizing: 'border-box' }}>
            ...
            <Box sx={{ maxWidth: 260, mx: 'auto', position: 'relative' }}>
              ...
              <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -60%)', textAlign: 'center', pointerEvents: 'none' }}>
                ...
                <Typography sx={{ fontWeight: 800, fontSize: 13 }}>{formatCurrency(summary.total_general)}</Typography>
              </Box>
            </Box>
          </Paper>
        </Box>
