...
export default function Caja() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <Button
            ...
            disabled={!!corteHoy}
            sx={{ borderRadius: 2, fontWeight: 700, background: corteHoy ? undefined : `linear-gradient(135deg, ${ACCENT}, #22D3EE)`, boxShadow: corteHoy ? 'none' : `0 4px 14px ${ACCENT}30` }}
          >
      ...
      >
        <Box sx={{ height: 5, background: `linear-gradient(90deg, ${ACCENT}, #22D3EE)` }} />
        ...
        <DialogActions sx={{ px: 3, pb: 2.5, pt: 1, gap: 1 }}>
          ...
          <Button onClick={handleCerrarCaja} disabled={submitting} variant="contained"
            ...
            sx={{ borderRadius: 2, fontWeight: 700, flex: isMobile ? 1 : 'none', background: `linear-gradient(135deg, ${ACCENT}, #22D3EE)`, boxShadow: `0 4px 14px ${ACCENT}30`, color: '#fff' }}
          >
