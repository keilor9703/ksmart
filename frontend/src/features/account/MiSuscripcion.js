...
const HeroCard = ({ suscripcion, planActual, onRefresh, refreshing }) => {
  ...
  return (
    <Card elevation={0} sx={{
      ...
      background: isDark
        ? `linear-gradient(135deg, ${alpha(status.color, 0.08)} 0%, ${alpha('#0A0A0A', 0.9)} 100%)`
  ...
  return (
    <Box sx={{ pt: 2 }}>
      ...
      <Card elevation={0} sx={{
        ...
        background: isDark
          ? `linear-gradient(135deg, ${alpha('#C74634', 0.1)} 0%, ${alpha('#0A0A0A', 0.9)} 100%)`
