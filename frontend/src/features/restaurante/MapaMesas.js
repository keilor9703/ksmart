            ...
            {itemsActivos.map(item => {
              ...
              return (
                <Box key={item.id} sx={{
                  ...
                  <Typography fontSize={13} fontWeight={700} color="#0891B2" sx={{ flexShrink: 0, minWidth: 58, textAlign: 'right' }}>
                    {fmt(item.subtotal)}
                  </Typography>
        ...
        {itemsActivos.length > 0 && (
          <Box sx={{ mt: 2, pt: 2, borderTop: `2px solid ${theme.palette.divider}` }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
              ...
              <Typography fontWeight={900} fontSize={18} color="#0891B2">{fmt(comanda.total + propina)}</Typography>
            </Box>
                ...
                <Box key={categoria}>
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      bgcolor: isDark ? alpha('#0891B2', 0.08) : alpha('#0891B2', 0.06),
                      '&:hover': { bgcolor: alpha('#0891B2', 0.12) },
                    }}
                  >
                    <Typography fontSize={11} fontWeight={800} color="#0891B2" textTransform="uppercase"
                      letterSpacing={0.8} sx={{ flex: 1 }}>
                      {categoria}
                    </Typography>
                    <Typography fontSize={10} color="text.disabled" sx={{ mr: 0.5 }}>{prods.length}</Typography>
                    {open ? <ExpandLess sx={{ fontSize: 16, color: '#0891B2' }} /> : <ExpandMore sx={{ fontSize: 16, color: '#0891B2' }} />}
                  </Box>
                        ...
                        return (
                          <Box key={prod.id} onClick={() => addToSelected(prod)} sx={{
                            ...
                            {imgSrc ? (
                              ...
                              <Box sx={{ width: 44, height: 44, borderRadius: 1.5, bgcolor: alpha('#0891B2', 0.12), display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                <Typography sx={{ fontSize: 20, fontWeight: 800, color: '#0891B2', opacity: 0.7 }}>
                            ...
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                ...
                                <Typography fontSize={13} fontWeight={700} color="#0891B2" sx={{ flexShrink: 0 }}>
                                  {fmt(prod.precio)}
                                </Typography>
                              </Box>
                              {prod.descripcion && (
      ...
      <Box sx={{ px: 2, py: 1.5, display: 'flex', alignItems: 'center', gap: 1.5, borderBottom: `1px solid ${theme.palette.divider}`, flexShrink: 0 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, flexShrink: 0 }}>
          <Chip label={fmt(comanda.total)} size="small"
            sx={{ fontWeight: 900, bgcolor: alpha('#0891B2', 0.1), color: '#0891B2', fontSize: 12 }} />
                  ...
                  {groupedByCategory.map(({ categoria, prods }) => {
                    ...
                    return (
                      <Box key={categoria}>
                        ...
                        >
                          <Typography fontSize={10} fontWeight={800} color="#0891B2" textTransform="uppercase"
                            letterSpacing={0.8} sx={{ flex: 1 }}>
                            {categoria}
                          </Typography>
                          <Typography fontSize={9} color="text.disabled" sx={{ mr: 0.5 }}>{prods.length}</Typography>
                          {open ? <ExpandLess sx={{ fontSize: 14, color: '#0891B2' }} /> : <ExpandMore sx={{ fontSize: 14, color: '#0891B2' }} />}
                        </Box>
                        {/* Products */}
                        {open && (
                              ...
                              return (
                                ...
                                >
                                  {imgSrc ? (
                                    ...
                                    <Box sx={{ width: 38, height: 38, borderRadius: 1.5, bgcolor: alpha('#0891B2', 0.12), display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                      <Typography sx={{ fontSize: 17, fontWeight: 800, color: '#0891B2', opacity: 0.7 }}>
                                        {(prod.nombre || '?')[0].toUpperCase()}
                                      </Typography>
                                    </Box>
                                  )}
                                  <Box sx={{ flex: 1, minWidth: 0 }}>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                      ...
                                      <Typography fontSize={12} fontWeight={700} color="#0891B2" sx={{ flexShrink: 0 }}>
                                        {fmt(prod.precio)}
                                      </Typography>
                                    </Box>
                                    {prod.descripcion && (
      ...
      {comanda && (
        <>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 0.3 }}>
            <Typography fontSize={11} fontWeight={800} color="#0891B2">
              {fmt(comanda.total)}
            </Typography>
            {esAutoservicio && (
          ...
          {zonas.map(z => (
            <Chip key={z} label={z === 'todas' ? 'Todas las zonas' : z}
              ...
              sx={{
                ...
                bgcolor: zonaFiltro === z ? '#0891B2' : alpha(theme.palette.divider, 1),
                color: zonaFiltro === z ? '#fff' : 'text.secondary',
                '&:hover': { bgcolor: zonaFiltro === z ? '#E8531A' : alpha('#0891B2', 0.1) },
              }} />
          ))}
        </Box>
      )}
