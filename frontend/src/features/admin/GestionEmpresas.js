...
import {
  ...
  ViewModule, Close, Storefront, Dns, Terminal,
...
import LogsBackendTab from './components/LogsBackendTab';
...
const TABS_CONFIG = [
  ...
  { label: 'Logs', icon: <Terminal fontSize="small" />, fullLabel: 'Logs del Backend en Vivo' },
];
